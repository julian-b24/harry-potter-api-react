...
function PotionDetails() {
  ...
  const getPotion = async () => {
    try {
      ...
      setPotionImage(response.data.data.attributes.image);
    } catch (error) {
      console.log(error);
    }
  };
          ...
          >
            <Grid item xs={6} sx={{ display: "flex" }}>
              ...
              <AspectRatio objectFit="contain" sx={{ width: 600 }}>
                <img
                  src={potionImage === null ? DEFAULT_IMAGE : potionImage}
            ...
            <Grid item xs={6}>
              ...
              <AccordionGroup sx={{ maxWidth: "100%", fontSize: "1.2em" }}>
                <Accordion
                  size="lg"
                  disabled={potion.attributes.characteristics === null}
                >
              ...
              >
                ...
                {potion.attributes.effect && (
                  <ListItem>
                    ...
                    <ListItemText
                      primary="Effect"
                      secondary={potion.attributes.effect}
                    />
                  </ListItem>
                )}
                ...
                {potion.attributes.time && (
                  <ListItem>
                    ...
                    <ListItemText
                      primary="Time"
                      secondary={potion.attributes.time}
                    />
                  </ListItem>
                )}
                ...
                {potion.attributes.difficulty && (
                  <ListItem>
                    ...
                    <ListItemText
                      primary="Difficulty"
                      secondary={potion.attributes.difficulty}
                    />
                  </ListItem>
                )}
                ...
                {potion.attributes.side_effects && (
                  <ListItem>
                    ...
                    <ListItemText
                      ...
                      secondary={potion.attributes.side_effects}
                    />
                  </ListItem>
                )}
                ...
                {potion.attributes.wiki && (
                  <ListItem>
                    ...
                    <ListItemText
                      primary="Wiki"
                      secondary={potion.attributes.wiki}
                    />
                  </ListItem>
                )}
              </List>
