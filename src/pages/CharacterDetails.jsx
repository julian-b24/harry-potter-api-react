          ...
          <Grid container
            ...
            <Grid item xs={6}>
              ...
              <AccordionGroup sx={{ maxWidth: '100%', fontSize: '1.2em' }}>
                <Accordion size="lg" disabled={character.attributes.alias_names === null}>
                ...
                <Accordion size="lg" disabled={character.attributes.family_members === null}>
                ...
                <Accordion size="lg" disabled={character.attributes.jobs === null}>
                  <AccordionSummary>Jobs</AccordionSummary>
                  <AccordionDetails>{character.attributes.jobs}</AccordionDetails>
                </Accordion>

                <Accordion size="lg" disabled={character.attributes.romances === null}>
                ...
                <Accordion size="lg" disabled={character.attributes.wands === null}>
             ...
             animagus, died,  and wiki link*/}
              <List
                sx={{ width: '100%', maxWidth: 360, display: 'flex', flexDirection: 'row', flexWrap: 'nowrap' }}
              >
                {/*Born*/}
